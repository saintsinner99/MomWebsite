...
import { Heart, Scissors, Gift, Sparkles, Facebook, Mail, Leaf } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#fffaf3] text-[#3f2f24]">
      <header className="sticky top-0 z-50 border-b border-[#eadccb] bg-[#fffaf3]/90 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
          ...
          <a href={facebookUrl} target="_blank" rel="noreferrer" className="rounded-full bg-[#8b5e3c] px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-[#71482d]">Message</a>
        </div>
      </header>
          ...
          <div className="relative mx-auto grid max-w-6xl gap-10 px-5 py-20 md:grid-cols-[1.05fr_.95fr] md:py-28">
            <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="flex flex-col justify-center">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <a href={facebookUrl} target="_blank" rel="noreferrer" className="inline-flex items-center justify-center rounded-full bg-[#8b5e3c] px-7 py-3 text-base font-semibold text-white transition hover:bg-[#71482d]">
                  <Facebook className="mr-2 h-5 w-5" /> Shop on Facebook
                </a>
                <a href="#custom" className="inline-flex items-center justify-center rounded-full border border-[#8b5e3c] px-7 py-3 text-base font-semibold text-[#8b5e3c] transition hover:bg-[#f4eadf]">Request Custom Order</a>
              </div>
            </motion.div>
        ...
        <section id="shop" className="mx-auto max-w-6xl px-5 py-20">
          ...
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {products.map((item) => {
              ...
              return (
                <div key={item.title} className="rounded-[1.5rem] border border-[#eadccb] bg-white/80 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
        ...
        <section id="custom" className="bg-[#3f2f24] px-5 py-20 text-white">
          <div className="mx-auto grid max-w-6xl gap-10 md:grid-cols-[.9fr_1.1fr] md:items-center">
            <div>
              ...
              <a href={facebookUrl} target="_blank" rel="noreferrer" className="mt-8 inline-flex items-center justify-center rounded-full bg-white px-7 py-3 text-base font-semibold text-[#3f2f24] transition hover:bg-[#f4eadf]">
          ...
          <div className="mx-auto max-w-6xl rounded-[2rem] bg-[#8b5e3c] p-8 text-white shadow-xl md:p-12">
            <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
              ...
              <div className="flex flex-col gap-3 sm:flex-row md:flex-col">
                <a href={facebookUrl} target="_blank" rel="noreferrer" className="inline-flex items-center justify-center rounded-full bg-white px-7 py-3 text-base font-semibold text-[#8b5e3c] transition hover:bg-[#f4eadf]">
                  <Facebook className="mr-2 h-5 w-5" /> Visit Facebook
                </a>
                <a href="mailto:hello@cinnamonstitchcottage.com" className="inline-flex items-center justify-center rounded-full border border-white px-7 py-3 text-base font-semibold text-white transition hover:bg-white/10">
